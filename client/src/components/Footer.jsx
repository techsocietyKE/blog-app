  ...
  return (
    ...
    <div className="container px-6 py-12 mx-auto">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
            ...
            <div>
                <p className="font-semibold text-gray-800 dark:text-white">Other Links</p>
        ...
        <p className="font-sans p-8 text-start md:text-center md:text-lg md:p-4">© {new Date().getFullYear()} Techmasters Inc. All rights reserved.</p>
    </div>
</footer>
  )
}
